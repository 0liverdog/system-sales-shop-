...
if (lista == null) {
    Dao dao = new Dao();
    lista = dao.listarProductoPorEstado(1);
}
%>
...
<main class="main">
  ...
  <div class="page-header">
    ...
    <p>Gestiona el inventario de productos disponibles</p>
  </div>

  <div class="toolbar">
    <a href="nuevoProducto.jsp" class="btn btn-primary">
  ...
  <div class="panel">
    <div class="table-wrap">
      <table>
        ...
        %>
          <tr>
            <td style="color:var(--text-3)"><%= p.getId_producto() %></td>
            <td style="font-weight:500"><%= p.getNombre() %></td>
            <td style="color:var(--cyan)">S/ <%= String.format("%.2f", p.getPrecio()) %></td>
            <td style="color:var(--text-2)"><%= p.getCategoria() %></td>
            <td style="color:var(--text-2)"><%= p.getStock() %></td>
            <td><span class="badge badge-success">Activo</span></td>
            <td>
              <a href="editarProducto.jsp?id=<%= p.getId_producto() %>" class="btn btn-warning btn-sm">
                Editar
              </a>
              <a href="CambiarEstado?tabla=producto&campo=id_producto&id=<%=p.getId_producto()%>&estado=0" 
  ...
  <div class="footer-actions">
    ...
    <a href="listarProductosInactivos.jsp" class="btn btn-danger">
      Ver Inactivos
    </a>
  </div>
