...
.nav-item.active svg {
  stroke: var(--emerald);
  filter: drop-shadow(0 0 8px rgba(46,204,113,.12));
}
...
<%
Dao dao = new Dao();
List<Venta> lista = dao.listarVentaPorEstado(0);
%>
...
<main class="main">
	...
	<svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      <span class="page-title-text">Ventas Inactivas</span>
	</h1>
	</div>
	...
	<div class="table-card">
		...
		<div class="empty-state-text">No hay ventas inactivas</div>
			</div>            
            </td>
            </tr>
            <%
            ...
            <tr>
            <td style="font-weight: 600; color: var(--text-3);"><%= v.getId_venta() %></td>
              <td style="font-weight: 600; color: var(--text-3);"><%= v.getFecha() %></td>
               <td style="color: var(--amber); font-weight: 600;"><%= v.getTotal()%></td>
                <td style="color: var(--amber); font-weight: 600;"><%= v.getId_cliente()%></td>
                <td>
                <span class="badge badge-inactive">Anulado</span>
                </td>
                <td>
                <a href="listadoDetalleVenta.jsp?idVenta=<%=v.getId_venta()%>" class="btn btn-success btn-sm">Ver Detalle</a>
                </td>
                <td>
                <a href="CambiarEstado?tabla=venta&campo=id_venta&id=<%=v.getId_venta()%>&estado=1" class="btn btn-success btn-sm">
                ...
                <td>
                <a href="EliminarVenta?id=<%=v.getId_venta()%>" onclick="return confirm('¿Seguro que quieres elimnar esta venta?')" class="btn btn-danger btn-sm">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
