...
<main class="main">
	...
	<input type="hidden" name="accion" value="InsertarCliente">
	...
	<input 
                ...
                name="nombre" 
                class="form-control" 
                placeholder="Ej: Rodrigo Miranda"
                required
                autofocus
              >
	...
	<input 
	 ...
	 <div class="helper-text">DNI del cliente (opcional)</div>
	</div>
	...
	<input 
      ...
      <svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="helper-text">Número de contacto del (opcional)</div>
          </div>  
