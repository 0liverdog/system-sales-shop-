...
.btn-primary:hover {
  ...
  box-shadow: 0 8px 20px rgba(255, 92, 107, 0.3);
}
...
if (lista == null) {
    Dao dao = new Dao();
    lista = dao.listarClientePorEstado(1);
}
%>
...
<main class="main">
  ...
  <div class="toolbar">
    <a href="nuevoCliente.jsp" class="btn btn-primary">
  ...
  <div class="panel">
    <div class="table-wrap">
      <table>
        ...
        %>
          <tr>
            <td style="color:var(--text-3)"><%= c.getId_cliente() %></td>
            <td style="font-weight:500"><%= c.getNombre() %></td>
            <td style="color:var(--cyan)"><%= c.getDni() %></td>
            <td style="color:var(--text-2)"><%= c.getTelefono() %></td>
            <td><span class="badge badge-success">Activo</span></td>
            <td>
              <a href="editarCliente.jsp?id=<%= c.getId_cliente() %>" class="btn btn-warning btn-sm">
                Editar
              </a>
              <a href="CambiarEstado?tabla=cliente&campo=id_cliente&id=<%=c.getId_cliente()%>&estado=0" 
  ...
  <div class="footer-actions">
    ...
    <a href="listadoClienteInactivo.jsp" class="btn btn-danger">
      Ver Inactivos
    </a>
  </div>
