<%@ page import="java.util.List, Entidades.Producto, Dao.Dao" %>
...
<%
Dao dao = new Dao();
List<Producto> lista = dao.listarProductoPorEstado(0);
%>
...
<main class="main">
  ...
  <div class="page-header">
    <h1 class="page-title">
      ...
      <span class="page-title-text">Productos Inactivos</span>
    </h1>
  </div>
  ...
  <div class="table-container">
    <div class="table-card">
      ...
      <table class="data-table">
          ...
          <tr>
            <td colspan="8">
              <div class="empty-state">
                ...
                <div class="empty-state-text">No hay productos inactivos</div>
              </div>
            </td>
          </tr>
        <%
        ...
        %>
          <tr>
            <td style="font-weight: 600; color: var(--text-3);"><%= p.getId_producto() %></td>
            <td style="text-align: left; font-weight: 500;"><%= p.getNombre() %></td>
            <td style="color: var(--amber); font-weight: 600;">S/ <%= String.format("%.2f", p.getPrecio()) %></td>
            <td style="color: var(--text-2);"><%= p.getCategoria() %></td>
            <td style="font-weight: 600;"><%= p.getStock() %></td>
            <td>
              <span class="badge badge-inactive">Inactivo</span>
            </td>
            <td>
              <a href="CambiarEstado?tabla=producto&campo=id_producto&id=<%=p.getId_producto()%>&estado=1"
            ...
            <td>
              <a href="EliminarProducto?id=<%=p.getId_producto() %>" 
  ...
  <div class="actions-bar">
    <a href="listadoProducto.jsp" class="btn btn-success">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <polyline points="20 6 9 17 4 12"/>
      </svg>
