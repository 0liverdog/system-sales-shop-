...
if (lista == null) {
    Dao dao = new Dao();
    lista = dao.listarProveedorPorEstado(1);
}
%>
...
<main class="main">
  ...
  <div class="page-header">
    ...
    <p>Gestiona tus proveedores y sus datos de contacto</p>
  </div>

  <div class="toolbar">
    <a href="nuevoProveedor.jsp" class="btn btn-primary">
    ...
    <form action="Gestionar" method="get" class="search-form">
      <input type="hidden" name="accion" value="BuscarProveedor">
      <div class="search-box">
        <svg viewBox="0 0 24 24" stroke-linecap="round">
          <circle cx="11" cy="11" r="8"/>
          <line x1="21" y1="21" x2="16.65" y2="16.65"/>
        </svg>
        <input type="text" name="ruc" placeholder="Buscar por RUC...">
      </div>
  ...
  <div class="panel">
    <div class="table-wrap">
      <table>
        ...
        %>
          <tr>
            <td style="color:var(--text-3)"><%=p.getId_proveedor()%></td>
            <td style="font-weight:500"><%=p.getNombre()%></td>
            <td style="color:var(--cyan)"><%=p.getRuc()%></td>
            <td style="color:var(--text-2)"><%=p.getTelefono()%></td>
            <td><span class="badge badge-success">Activo</span></td>
            <td>
              <a href="editarProveedor.jsp?id=<%= p.getId_proveedor() %>" class="btn btn-warning btn-sm">
                Editar
              </a>
              <a href="CambiarEstado?tabla=proveedor&campo=id_proveedor&id=<%=p.getId_proveedor()%>&estado=0" 
  ...
  <div class="footer-actions">
    ...
    <a href="listadoProveedorInactivo.jsp" class="btn btn-danger">
      Ver Inactivos
    </a>
  </div>
