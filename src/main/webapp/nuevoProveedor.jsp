...
<main class="main">
    ...
    <div class="form-card">
      ...
      <div class="form-body">
        <form action="Gestionar" method="post">
          ...
          <input type="hidden" name="accion" value="InsertarProveedor">
          ...
          <div class="form-group">
            ...
            <div class="input-with-icon">
              <input 
                ...
                name="nombre" 
                class="form-control" 
                placeholder="Ej: Distribuidora San Miguel SAC"
                required
                autofocus
              >
  ...
  <path d="M13 16h4"/>
            ...
            <div class="helper-text">Ingrese el RUC de 11 dígitos</div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="helper-text">Número de contacto del proveedor (opcional)</div>
          </div>
