<%@ page import="java.util.List, Entidades.Cliente, Dao.Dao" %>
...
<%
Dao dao = new Dao();
List<Cliente> lista = dao.listarClientePorEstado(0);
%>
...
<main class="main"> 
	...
	<h1 class="page-title">
      ...
      <span class="page-title-text">Clientes Inactivos</span>
	</h1>
</div>
		...
		<div class="table-card">
			...
			<div class="empty-state-text">No hay clientes activos</div>
			</div>			
			</td>
			</tr>
			...
			%>
			<tr>
				<td style="font-weight: 600; color: var(--text-3);"><%= c.getId_cliente() %></td>
				<td style="text-align: left; font-weight: 500;"><%= c.getNombre() %></td>
				<td style="text-align: left; font-weight: 500;"><%= c.getDni() %></td>
				<td>
					<span class="badge badge-inactive">Inactivo</span>
				</td>
				<td>
					<a href="CambiarEstado?tabla=cliente&campo=id_cliente&id=<%=c.getId_cliente()%>&estado=1"
				...
				<td>
				<a href="EliminarCliente?id=<%=c.getId_cliente()%>"
				onclick="return confirm('¿Seguro que quieres eliminar este cliente?')" class="btn btn-danger btn-sm">
				<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a href="listadoCliente.jsp" class="btn btn-success">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <polyline points="20 6 9 17 4 12"/>
      </svg>
